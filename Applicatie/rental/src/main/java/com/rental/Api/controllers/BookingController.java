...
public class BookingController {
    ...
    public ResponseEntity createBooking(@RequestBody Booking booking) {
        try {
            ...
            if (createdBooking == null) return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Failed to create booking");
    ...
    public ResponseEntity editBooking(@PathVariable UUID id, @RequestBody Booking booking) {
        try {
            ...
            if (updatedBooking == null) return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Failed to update booking");
    ...
    public ResponseEntity returnBookingByBookingNumber(@PathVariable String bookingNumber) {
        try {
            ...
            if (bookingToReturn == null) return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Booking does not exist");
